...
def add_note(title,description,status):
	conn = sqlite3.connect('db')
...
def update_note(title,description,status,id):
	conn = sqlite3.connect('db')
...
def add_data(title,description,status):
	add_note(title,description,status)
def get_data():
	return get_notes()
...
def manage():
	...
	if sel=='1':
		...
		update_note(title,descrip,status,id__)
